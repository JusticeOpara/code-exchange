...
const buttonVariants = cva(
  "ring-offset-background focus-visible:ring-ring inline-flex items-center justify-center whitespace-nowrap rounded-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "no-focus hover:drop-shadow-l h-8 w-full rounded-full bg-gradient-to-r primary-gradient  text-sm text-white shadow-lg transition-all duration-1000 hover:cursor-pointer ",
        default_small:
          "no-focus mx-auto w-fit rounded-full bg-gradient-to-r primary-gradient !px-8 text-sm text-white shadow-lg transition-all duration-1000 hover:cursor-pointer  hover:drop-shadow-lg",
        destructive:
